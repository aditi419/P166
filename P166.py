...
label.place(root,relx=0.2,rely=0.8,anchor=CENTER)
...
dropdown.place(root,relx=0.35,rely=0.8,anchor=CENTER)



startx = Label(root,text='startx')
startx.place(root,relx=0.4,rely=0.8,anchor=CENTER)
...
dropdown2.place(root,relx=0.45,rely=0.8,anchor=CENTER)


starty = Label(root,text='starty')
starty.place(root,relx=0.5,rely=0.8,anchor=CENTER)

coordinates_values = [10,50,100,200,300,400,500,600,800,900]

dropdown3 = ttk.Combobox(state='readonly',values=coordinates_values,width=10)
dropdown3.place(root,relx=0.55,rely=0.8,anchor=CENTER)


endx = Label(root,text='startx')
endx.place(root,relx=0.6,rely=0.8,anchor=CENTER)

coordinates_values = [10,50,100,200,300,400,500,600,800,900]

dropdown4 = ttk.Combobox(state='readonly',values=coordinates_values,width=10)
dropdown4.place(root,relx=0.65,rely=0.8,anchor=CENTER)


endy = Label(root,text='startx')
endy.place(root,relx=0.7,rely=0.8,anchor=CENTER)

coordinates_values = [10,50,100,200,300,400,500,600,800,900]

dropdown5 = ttk.Combobox(state='readonly',values=coordinates_values,width=10)
dropdown5.place(root,relx=0.75,rely=0.8,anchor=CENTER)
